//! Auto-generated client for the identity_lab program.
...
pub struct VerifyAgeProofAccounts {
    pub authority: AccountId,
}

pub struct IdentityLabClient<'w> {
    pub wallet: &'w WalletCore,
    pub program_id: ProgramId,
}

impl<'w> IdentityLabClient<'w> {
    pub fn new(wallet: &'w WalletCore, program_id: ProgramId) -> Self {
        Self { wallet, program_id }
    }

    pub async fn verify_age_proof(
        &self,
        accounts: VerifyAgeProofAccounts,
        proof: Vec<u8>,
        min_age: u8,
